...
# =============================================================================
train_data=Datset5_train_features # Defining the Dataset to use
train_labels=Datset5_train_labels # Defining data set labels
test_data=x_set5   # test Set
test_lables=y_set5 #Test seT labels
...
# Building the model
clf = NuSVC(nu=0.7, kernel='sigmoid',probability=True)#probability=True
