# -*- coding: utf-8 -*-
"""
Created on Fri Jun  1 01:09:21 2018
...
with tf.Graph().as_default():
     ...
     dense1 = tflearn.fully_connected(input_layer, 64, activation='tanh',weights_init=tflearn.initializations.zeros(),bias_init=tflearn.initializations.zeros(),regularizer='L2')
     network = tflearn.layers.normalization.batch_normalization(dense1)
     dense2 = tflearn.fully_connected(network, 64, activation='tanh',weights_init=tflearn.initializations.zeros(),bias_init=tflearn.initializations.zeros(),regularizer='L2')
