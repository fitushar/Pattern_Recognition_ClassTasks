# -*- coding: utf-8 -*-
"""
Created on Fri Jun  1 14:58:18 2018
...
with tf.Graph().as_default():
    ...
    dense2 = tflearn.fully_connected(dense1, 64, activation='tanh',weights_init=tflearn.initializations.uniform(),bias_init=tflearn.initializations.uniform(),regularizer='L2')
