# -*- coding: utf-8 -*-
"""
Created on Fri Jun  1 14:52:02 2018
...
with tf.Graph().as_default():
    ...
    dense1 = tflearn.fully_connected(input_layer,64, activation='tanh',weights_init=tflearn.initializations.uniform(),bias_init=tflearn.initializations.uniform(),regularizer='L2')
    batch_normalization = tflearn.layers.normalization.batch_normalization(dense1)
    dense2 = tflearn.fully_connected(batch_normalization, 64, activation='tanh',weights_init=tflearn.initializations.uniform(),bias_init=tflearn.initializations.uniform(),regularizer='L2')
