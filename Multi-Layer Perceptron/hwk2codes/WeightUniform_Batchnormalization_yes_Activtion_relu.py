# -*- coding: utf-8 -*-
"""
Created on Fri Jun  1 14:45:39 2018
...
with tf.Graph().as_default():
    ...
    dense2 = tflearn.fully_connected(batch_normalization, 64, activation='relu',weights_init=tflearn.initializations.uniform(),bias_init=tflearn.initializations.uniform(),regularizer='L2')
