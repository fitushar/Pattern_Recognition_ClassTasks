# -*- coding: utf-8 -*-
"""
Created on Fri Jun  1 01:16:03 2018
...
with tf.Graph().as_default():
     ...
     dense2 = tflearn.fully_connected(dense1, 64, activation='relu',weights_init=tflearn.initializations.zeros(),bias_init=tflearn.initializations.zeros(),regularizer='L2')
